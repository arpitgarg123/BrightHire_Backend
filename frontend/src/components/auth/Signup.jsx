...
<div className='flex items-center gap-2'>
  ...
  />
        ...
        {
          Loading ? <Button type="submit" className="w-full my-5"> <Loader2 className='mr-2 h-4 w-4 animate-spin' /> please wait</Button> :  <Button type="submit" className="w-full my-5">Sign up</Button>
        }
