...
const Footer = () => {
  return (
    <footer className= " bg-white border-t shadow-sky-950 py-10">
      <div className="container mx-auto text-center flex items-center justify-between px-12">
           <div>
           <h1 className='text-2xl font-bold'>Bright<span className='text-[#F83002]'>Hire</span> </h1>
           <p className="text-sm">&copy; {new Date().getFullYear()} BrightHire. All rights reserved.</p>
           </div>
